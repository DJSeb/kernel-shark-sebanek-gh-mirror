...
\def\ThesisTitle{\xxx{Vizualizace trasování procesů v Linuxu}}

% Název práce v angličtině
\def\ThesisTitleEN{\xxx{Visualization of tracing of processes in Linux}}

% Jméno autora (vy)
\def\ThesisAuthor{\xxx{David Jaromír Šebánek}}
...
\def\Supervisor{\xxx{RNDr. Jan Kára, Ph.D.}}
...
\def\StudyProgramme{\xxx{Informatika (B0613A140006)}}

% Nepovinné poděkování (vedoucímu práce, konzultantovi, tomu, kdo
% vám nosil pizzu a vařil čaj apod.)
\def\Dedication{%
\xxx{Poděkování.} [TODO]
    VS Code, ChatGPT, Qt dokumentace, hwloc dokumentace, Linux kernel dokumentace, WSL, Yordan K., J. Kára, atd.
}
...
\def\ThesisKeywords{%
\xxx{Linux\sep trasování}
}

\def\ThesisKeywordsEN{
\xxx{Linux\sep tracing}
}
