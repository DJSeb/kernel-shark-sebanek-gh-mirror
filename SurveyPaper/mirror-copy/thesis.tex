...
\include{1_trasování_v_linuxu}
\include{2_vizualizace_traceů}
\include{3_kshark}
\include{4_obecná_analýza}                  %%% OBECNÁ ANALÝZA
\include{5_record_kstack}                   %%% ANALÝZA & VÝVOJ & UŽÍVÁNÍ pro kažou část zvlášť
\include{6_stacklook}                          
\include{7_couplebreak}
\include{8_naps}
\include{9_numatv}
\include{10_dodatečné}

\include{zaver}                             %%% ZÁVĚR + možná rozšíření
